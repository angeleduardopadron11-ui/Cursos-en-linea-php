...
¡Hola, <span style="color: #38bdf8;"><?php echo $_SESSION['nombre'] ?? 'Usuario'; ?></span>!
</h1>
...
<h3 class="h4 text-white fw-bold mb-3">Gestión de Cursos</h3>
<p class="text-white-50 mb-4">Accede para configurar, editar o añadir nuevos cursos al catálogo de la academia.</p>
...
GESTIÓN DE CURSOS <i class="bi bi-arrow-right-short ms-2"></i>
</a>
</div>
</div>
</div>
...
/* Animación: El icono gira y brilla al pasar el mouse */
